		...
		while (!partida.getXequeMate()) {
			try {
				...
				if (partida.getPecaPromovida() != null) {
					System.out.print("Insira peça para promoção (C/B/T/RA): ");
					String tipo = scan.nextLine().toUpperCase();
					while (!tipo.equals("C") && !tipo.equals("B") && !tipo.equals("T") & !tipo.equals("RA")) {
						System.out.print("Valor inválido! Insira peça para promoção (C/B/T/RA): ");
